		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "flexColumn",
									"targetURL": "#comproyflexcolumn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproyflexcolumn-display": {
								"semanticObject": "comproyflexcolumn",
								"action": "display",
								"description": "flexColumn",
								"title": "flexColumn",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.proy.flexcolumn",
									"url": sap.ui.require.toUrl("com/proy/flexcolumn")
								}
							}
						}
					}
